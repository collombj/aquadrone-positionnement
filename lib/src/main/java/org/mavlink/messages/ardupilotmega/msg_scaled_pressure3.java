/**
 * Generated class : msg_scaled_pressure3
 * DO NOT MODIFY!
 **/
...
public class msg_scaled_pressure3 extends MAVLinkMessage {
    ...
    public msg_scaled_pressure3(int sysId, int componentId) {
        messageType = MAVLINK_MSG_ID_SCALED_PRESSURE3;
        this.sysId = sysId;
